...
uploaded_file = col_1.file_uploader("Choose an image...", type=["jpg", "jpeg", "png"])
num_similar_images = col_2.slider('Number of similar images to retrieve',3,30)

col1, col2 = st.columns(2)
col1.header('Query Image:')
col2.header('Similar Images:')
